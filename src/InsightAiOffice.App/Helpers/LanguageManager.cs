...
public static class LanguageManager
{
    private static readonly Dictionary<string, Dictionary<string, string>> s_resources = new()
    {
        ["ja"] = new()
        {
            ...
            // Project
            ["Menu_Project"] = "プロジェクト",
            ["Project_New"] = "新規プロジェクト",
            ["Project_Open"] = "プロジェクトを開く",
            ["Project_Save"] = "プロジェクト上書き保存",
            ["Project_SaveAs"] = "プロジェクト別名保存",
            ...
            ["Pdf_Highlight"] = "ハイライト",
            ["Pdf_Underline"] = "下線",
            ["Pdf_Strikethrough"] = "取り消し線",
            ["Pdf_Ink"] = "フリーハンド",
            ["Pdf_Navigation"] = "ナビゲーション",
            ["Pdf_PrevPage"] = "前ページ",
            ["Pdf_NextPage"] = "次ページ",
            ["Pdf_ZoomIn"] = "拡大",
            ["Pdf_ZoomOut"] = "縮小",
            ["Pdf_Print"] = "印刷",
            ["Pdf_HighlightMode"] = "ハイライトモード — テキストを選択してハイライト",
            ["Pdf_UnderlineMode"] = "下線モード — テキストを選択して下線",
            ["Pdf_StrikethroughMode"] = "取り消し線モード — テキストを選択して取り消し線",
            ["Pdf_InkMode"] = "フリーハンドモード — マウスで描画",

            // PDF Phase 2
            ["Pdf_Edit"] = "編集",
            ["Pdf_PageOps"] = "ページ操作",
            ["Pdf_RotateRight"] = "回転（右）",
            ["Pdf_RotateLeft"] = "回転（左）",
            ["Pdf_DeletePage"] = "ページ削除",
            ["Pdf_MergeSplit"] = "結合・分割",
            ["Pdf_Merge"] = "PDF結合",
            ["Pdf_Split"] = "ページ分割",
            ["Pdf_Insert"] = "挿入",
            ["Pdf_AddText"] = "テキスト追加",
            ["Pdf_Watermark"] = "透かし",
            ["Pdf_InsertImage"] = "画像挿入",
            ["Pdf_Security"] = "セキュリティ",
            ["Pdf_Protect"] = "パスワード保護",
            ["Pdf_Redact"] = "墨消し",
            ["Pdf_PageRotated"] = "ページ {0} を回転しました",
            ["Pdf_ConfirmDeletePage"] = "ページ {0} を削除しますか？",
            ["Pdf_PageDeleted"] = "ページ {0} を削除しました",
            ["Pdf_SelectMergeFile"] = "結合するPDFを選択",
            ...
            ["Pdf_WatermarkAdded"] = "透かしを追加しました",
            ["Pdf_SelectImage"] = "挿入する画像を選択",
            ["Pdf_ImageInserted"] = "画像を挿入しました: {0}",
            ["Pdf_EnterPassword"] = "パスワードを入力:",
            ["Pdf_Protected"] = "パスワード保護で保存しました: {0}",
            ["Pdf_EnterRedactText"] = "墨消しするテキストを入力:",
            ["Pdf_Redacted"] = "墨消しを適用しました",
            ["Pdf_RedactNotFound"] = "指定テキストが見つかりませんでした",
            ["Pdf_RedactApplied"] = "「{0}」を墨消ししました",
            ["Btn_Cancel"] = "キャンセル",

            // PDF Phase 3
            ["Pdf_Advanced"] = "高度な機能",
            ["Pdf_Form"] = "フォーム",
            ["Pdf_TextField"] = "テキストフィールド",
            ["Pdf_Checkbox"] = "チェックボックス",
            ["Pdf_ComboBox"] = "ドロップダウン",
            ["Pdf_FlattenForm"] = "フォームを平坦化",
            ["Pdf_DigitalSignature"] = "電子署名",
            ["Pdf_Signature"] = "署名追加",
            ["Pdf_VerifySignature"] = "署名検証",
            ["Pdf_OCR"] = "OCR",
            ["Pdf_Text"] = "テキスト",
            ["Pdf_ExtractText"] = "テキスト抽出",
            ["Pdf_SearchText"] = "テキスト検索",
            ["Pdf_EnterFieldName"] = "フィールド名を入力:",
            ["Pdf_EnterComboItems"] = "選択肢をカンマ区切りで入力:",
            ["Pdf_FieldAdded"] = "フォームフィールド「{0}」を追加しました",
            ["Pdf_NoFormFields"] = "フォームフィールドがありません",
            ["Pdf_ConfirmFlatten"] = "フォームを平坦化すると編集不可になります。続行しますか？",
            ["Pdf_FormFlattened"] = "フォームを平坦化しました",
            ["Pdf_SelectCertificate"] = "PFX証明書ファイルを選択",
            ["Pdf_EnterCertPassword"] = "証明書のパスワードを入力:",
            ["Pdf_Signed"] = "署名付きPDFを保存しました: {0}",
            ["Pdf_NoSignatures"] = "電子署名が見つかりません",
            ["Pdf_SigValid"] = "署名済み",
            ["Pdf_SigEmpty"] = "未署名",
            ["Pdf_PageNum"] = "ページ {0}",
            ["Pdf_NoTextFound"] = "テキストが見つかりませんでした",
            ["Pdf_TextExtracted"] = "テキスト抽出完了 — クリップボードにコピーしました（{0} 文字）",
            ["Pdf_EnterSearchText"] = "検索テキストを入力:",
            ["Pdf_Search"] = "テキスト検索",
            ["Pdf_Searching"] = "「{0}」を検索中…",
        ...
        ["en"] = new()
        {
            ...
            ["Project_SaveAs"] = "Save Project As",

            // File operations
            ["File_New"] = "New",
            ["File_NewText"] = "New Text",
            ["File_Open"] = "Open",
            ["File_Save"] = "Save",
            ["File_SaveAs"] = "Save As",
            ...
            // PDF
            ["Pdf_Annotation"] = "Annotations",
            ["Pdf_Highlight"] = "Highlight",
            ["Pdf_Underline"] = "Underline",
            ["Pdf_Strikethrough"] = "Strikethrough",
            ["Pdf_Ink"] = "Freehand",
            ["Pdf_Navigation"] = "Navigation",
            ["Pdf_PrevPage"] = "Previous Page",
            ["Pdf_NextPage"] = "Next Page",
            ["Pdf_ZoomIn"] = "Zoom In",
            ["Pdf_ZoomOut"] = "Zoom Out",
            ["Pdf_Print"] = "Print",
            ["Pdf_HighlightMode"] = "Highlight mode — select text to highlight",
            ["Pdf_UnderlineMode"] = "Underline mode — select text to underline",
            ["Pdf_StrikethroughMode"] = "Strikethrough mode — select text to strikethrough",
            ["Pdf_InkMode"] = "Freehand mode — draw with mouse",

            // PDF Phase 2
            ["Pdf_Edit"] = "Edit",
            ["Pdf_PageOps"] = "Page Operations",
            ["Pdf_RotateRight"] = "Rotate Right",
            ["Pdf_RotateLeft"] = "Rotate Left",
            ["Pdf_DeletePage"] = "Delete Page",
            ["Pdf_MergeSplit"] = "Merge / Split",
            ["Pdf_Merge"] = "Merge PDF",
            ["Pdf_Split"] = "Split Pages",
            ["Pdf_Insert"] = "Insert",
            ["Pdf_AddText"] = "Add Text",
            ["Pdf_Watermark"] = "Watermark",
            ["Pdf_InsertImage"] = "Insert Image",
            ["Pdf_Security"] = "Security",
            ["Pdf_Protect"] = "Password Protect",
            ["Pdf_Redact"] = "Redact",
            ["Pdf_PageRotated"] = "Page {0} rotated",
            ["Pdf_ConfirmDeletePage"] = "Delete page {0}?",
            ["Pdf_PageDeleted"] = "Page {0} deleted",
            ["Pdf_SelectMergeFile"] = "Select PDF files to merge",
            ...
            ["Pdf_WatermarkAdded"] = "Watermark applied",
            ["Pdf_SelectImage"] = "Select image to insert",
            ["Pdf_ImageInserted"] = "Image inserted: {0}",
            ["Pdf_EnterPassword"] = "Enter password:",
            ["Pdf_Protected"] = "Saved with password protection: {0}",
            ["Pdf_EnterRedactText"] = "Enter text to redact:",
            ["Pdf_Redacted"] = "Redaction applied",
            ["Pdf_RedactNotFound"] = "Specified text not found",
            ["Pdf_RedactApplied"] = "Redacted: \"{0}\"",
            ["Btn_Cancel"] = "Cancel",

            // PDF Phase 3
            ["Pdf_Advanced"] = "Advanced",
            ["Pdf_Form"] = "Forms",
            ["Pdf_TextField"] = "Text Field",
            ["Pdf_Checkbox"] = "Checkbox",
            ["Pdf_ComboBox"] = "Dropdown",
            ["Pdf_FlattenForm"] = "Flatten Form",
            ["Pdf_DigitalSignature"] = "Digital Signature",
            ["Pdf_Signature"] = "Add Signature",
            ["Pdf_VerifySignature"] = "Verify Signature",
            ["Pdf_OCR"] = "OCR",
            ["Pdf_Text"] = "Text",
            ["Pdf_ExtractText"] = "Extract Text",
            ["Pdf_SearchText"] = "Search Text",
            ["Pdf_EnterFieldName"] = "Enter field name:",
            ["Pdf_EnterComboItems"] = "Enter options (comma-separated):",
            ["Pdf_FieldAdded"] = "Form field \"{0}\" added",
            ["Pdf_NoFormFields"] = "No form fields found",
            ["Pdf_ConfirmFlatten"] = "Flattening makes form fields non-editable. Continue?",
            ["Pdf_FormFlattened"] = "Form fields flattened",
            ["Pdf_SelectCertificate"] = "Select PFX certificate file",
            ["Pdf_EnterCertPassword"] = "Enter certificate password:",
            ["Pdf_Signed"] = "Signed PDF saved: {0}",
            ["Pdf_NoSignatures"] = "No digital signatures found",
            ["Pdf_SigValid"] = "Signed",
            ["Pdf_SigEmpty"] = "Not signed",
            ["Pdf_PageNum"] = "Page {0}",
            ["Pdf_NoTextFound"] = "No text found",
            ["Pdf_TextExtracted"] = "Text extracted — copied to clipboard ({0} chars)",
            ["Pdf_EnterSearchText"] = "Enter search text:",
            ["Pdf_Search"] = "Search Text",
            ["Pdf_Searching"] = "Searching for \"{0}\"...",
